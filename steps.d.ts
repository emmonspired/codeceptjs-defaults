...
declare namespace CodeceptJS {
  ...
  export interface I {
    ...
    debug(msg: string) : void,
    debugSection(section: string, msg: string) : void,
    grabCreditCard(GoogleSheetsData?: string, EnvironmentData?: string) : Promise<string>,
    grabCreditCardForFulfillment(GoogleSheetsData?: string, EnvironmentData?: string) : Promise<string>,
    grabAccountForEmail(GoogleSheetsData?: string, email?: string) : Promise<string>,
    grabCrawlerExclusions(GoogleSheetsData?: string, EnvironmentData?: string) : Promise<string>,
    grabAccountForLevelAndDescription(GoogleSheetsData?: string, level: string, description: string) : Promise<string>,
    grabSiteDefaults(GoogleSheetsData?: string, EnvironmentData?: string) : Promise<string>,
    grabNewmanCollections(GoogleSheetsData?: string, EnvironmentData?: string) : Promise<string>,
    grabNewmanCollection(GoogleSheetsData?: string, EnvironmentData?: string, collectionName?: string) : Promise<string>,
    grabCoreAPIEnvironment(GoogleSheetsData?: string, EnvironmentData?: string, environmentName?: string) : Promise<string>,
    getWindowHandle() : void,
    switchToWindow(handle: string) : void,
    checkGetRequest(url: string, headers?: string) : void,
    checkPostRequest(url: string, payload?: string, headers?: string) : void,
    checkPatchRequest(url: string, payload: string, headers?: string) : void,
    checkPutRequest(url: string, payload?: string, headers?: string) : void,
    checkDeleteRequest(url: string, headers?: string) : void,
    pressKeys(text: string) : void,
    assertFullTextContainsSnippet(fullText: string, snippet: string, description?: string) : void,
    getMailObject(emailAddress: string) : void,
    buildSimpleGoogleMail(emailAddress: string) : void,
    waitForEmail(emailAddress: string, subject: string) : void,
    clearRecentMails(emailAddress: string) : void,
    tryToClick(string: string, object: string) : void,
    ...
    loginToTrainingPlatform(email: string, pw: string) : void,
    say: () => any; 
